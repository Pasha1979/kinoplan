...
export default function ScheduleVersionsPage() {
  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center gap-4" style={{ background: isDark ? '#13132a' : '#f4f4f8' }}>
      ...
      <h1 className="text-xl font-bold" style={{ color: isDark ? '#e5e7eb' : '#111827' }}>Версии КПП</h1>
      <p className="text-sm text-center max-w-xs" style={{ color: isDark ? '#6b7280' : '#9ca3af' }}>
        Сохранение нескольких вариантов календарно-постановочного плана. Сравнение версий и откат к предыдущей.
      </p>
