...
> **Назначение:** Жесткие архитектурные принципы, которые нельзя нарушать.
> 
> **Связанные документы:** [ПРАВИЛА_АРХИТЕКТУРЫ.md](./ПРАВИЛА_АРХИТЕКТУРЫ.md) | [scripts/check-architecture.ps1](../scripts/check-architecture.ps1)

---

🔗 НЕЙРОННЫЕ СВЯЗИ:
- Зависит от (читать перед изменением): `ПРАВИЛА_АРХИТЕКТУРЫ.md`
- Обновляет при изменении: `scripts/check-architecture.ps1`
...
| 02.06.2026 | Toast-система | Единый механизм уведомлений об ошибках/успехе | ✅ |
| 02.06.2026 | Cleanup Tiptap | Защита от утечек памяти при unmount | ✅ |
